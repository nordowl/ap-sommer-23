...
import HeaderImg from "@/public/images/slide-1.webp";
      ...
      <section>
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-8 lg:gap-16 space-y-6 md:space-y-0">
          ...
          <div>
            ...
            <div className="mt-4">
              <ArrowLink
                link=""
                title="Vorbereitung Seepferdchen (ab 4 Jahre)"
              />
              <ArrowLink
                link="/kurse/seepferdchen"
                title="Seepferdchen (5-10 Jahre)"
              />
              <ArrowLink link="" title="Schwimmabzeichen Bronze (7-14 Jahre)" />
              <ArrowLink
                link="/kurse/silber"
                title="Schwimmabzeichen Silber (7-14 Jahre)"
              />
            </div>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-8 lg:gap-16 space-y-6 md:space-y-0 mt-6">
          <div>
            ...
            <div className="mt-4">
              <ArrowLink
                link="/angebote-events/kindergeburtstag"
                title="Kindergeburtstag feiern"
              />
              <ArrowLink link="" title="Schwimmtanz und Wasserspiele" />
              <ArrowLink
                link="/angebote-events/filmnacht"
                title="Filmnacht für Familien"
              />
            </div>
          </div>
          <div>
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-8 lg:gap-16 space-y-6 md:space-y-0 mt-6">
            ...
            <div>
              <ArrowLink
                link=""
                title="Aquafit spezial: Joggen und Krafttraining"
              />
              <ArrowLink
                link=""
                title="Aquafit spezial: Radfahren und Krafttraining"
              />
            ...
            <div>
              <ArrowLink
                link=""
                title="Wassergymnastik in der Schwangerschaft"
              />

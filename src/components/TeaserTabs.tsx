...
import Img1 from "@/src/images/tab-img-1.webp"
import Img2 from "@/src/images/tab-img-2.webp"
import Img3 from "@/src/images/tab-img-3.webp"
import Img4 from "@/src/images/tab-img-4.webp"
...
const TeaserTabs = () => {
    ...
    useEffect(()=> {
        if (window.innerWidth >= 800) {
            ...
            document.querySelector(".teaser-tabs")?.addEventListener('mousemove', (e: any)=> {
                        ...
                        <Fragment key={item.title}>
                            <div className="teaser-tab">
                                ...
                                <div className="content">
                                    <h4>{item.title}</h4>
                                    <a href={item.btnLink} className="link">{item.btnText}</a>
                                </div>
                            </div>
